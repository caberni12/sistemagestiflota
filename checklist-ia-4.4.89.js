/* E-fleet Web 4.4.89 · NEXO IA Multimodal · R8.2.157 */
(() => {
  'use strict';
    ...
    try{
      ...
      if(!sessionId){
        ...
        if(analysis.KILOMETRAJE_REQUIERE_NUEVA_FOTO===true||analysis.KILOMETRAJE_VALIDADO!==true){
          ...
          throw new Error(`NEXO realizó ${intentos} intento(s) de lectura pero no pudo validar el odómetro (${analysis.KILOMETRAJE_MOTIVO||'lectura insuficiente'}). Las otras cuatro fotografías se conservan en el formulario: repita únicamente tablero/odómetro, acerque la cámara, evite reflejos y enfoque el valor ODO.`);
        }
